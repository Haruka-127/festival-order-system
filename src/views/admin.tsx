  ...
  if (event.event_type === "admin_action") {
    try {
      ...
      const labels: Record<string, string> = {
        item_created: "商品を追加",
        item_renamed: "商品名を変更",
        item_sort_changed: "商品の表示順を変更",
        item_availability_changed: "商品の販売状態を変更",
        item_sold_out_changed: "商品の売り切れ状態を変更",
        item_disabled: "商品を販売停止",
        item_deleted: "商品を削除",
        item_settings_changed: "商品設定を変更",
        staff_created: "スタッフを追加",
        staff_deleted: "スタッフを削除",
        staff_settings_changed: "スタッフ設定を変更",
        staff_password_changed: "スタッフのパスワードを変更",
        admin_password_changed: "管理者パスワードを変更",
        location_created: "提供場所を追加",
        location_settings_changed: "提供場所設定を変更",
        location_availability_changed: "提供場所の稼働状態を変更",
        order_settings_changed: "注文設定を変更",
        display_numbers_reset: "受付番号をリセット",
        backup_created: "バックアップを作成",
      };
